...
(function()
{
    ...
    gui.xmas.Model = function()
    {
		...
		this.masterRootPath = 'http://interactive.guim.co.uk/next-gen/lifeandstyle/ng-interactive/2014/nov/christmas-gift-guide-2014/';
		...
		this.shareRootPath = 'http://gu.com/p/43kkd/';
		this.isIe = (function(){
			var undef,
			v = 3,
